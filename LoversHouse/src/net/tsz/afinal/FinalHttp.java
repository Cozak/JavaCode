...
public class FinalHttp {
    ...
    private static int maxConnections = 10; //http鐠囬攱鐪伴張锟姐亣楠炶泛褰傛潻鐐村复閺侊拷    
    private static int socketTimeout = 10 * 1000; //鐡掑懏妞傞弮鍫曟？閿涘矂绮拋锟�缁夛拷    
    private static int maxRetries = 5;//闁挎瑨顕ょ亸婵婄槸濞嗏剝鏆熼敍宀勬晩鐠囶垰绱撶敮姝屻�鐠囧嘲婀猂etryHandler濞ｈ濮�    
    private static int httpThreadCount = 3;//http缁捐法鈻煎Ч鐘虫殶闁诧拷
    ...
    /**
     * 鐠佸墽鐤嗙純鎴犵捕鏉╃偞甯寸搾鍛閺冨爼妫块敍宀勭帛鐠併倓璐�0缁夋帡鎸�     * @param timeout
     */
    ...
    /**
     * 鐠佸墽鐤唄ttps鐠囬攱鐪伴弮锟�閻拷SSLSocketFactory
