...
public class CircleProgress extends View
{
    ...
    private int targetPg= 0;
    private int tarInterval = 1;
	...
	public void setTargetPg(int targetPg) {
		this.targetPg = targetPg;
		tarInterval =(int) ((100/targetPg) +0.5);
	}
	
	

	public void setMPg(int count) {
		if((tarInterval *count) <=100)
		this.setmSubCurProgress(tarInterval *count);
	}
